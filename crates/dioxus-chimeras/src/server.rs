...
use bytes::Bytes;
use chimeras::{Frame, PixelFormat};
...
/// let server = dioxus_chimeras::start_preview_server().unwrap();
/// dioxus_chimeras::register_with(&server, dioxus::LaunchBuilder::desktop()).launch(app);
/// ```
